...
////// Emissive:
                ...
                float node_6294 = ((node_727*node_6040)+(node_727*node_7551)); // R2
                ...
                float node_4751 = 1.1;
                float node_1846 = 1.7;
                float2 node_1563 = lerp((i.screenPos.rg+0.5*float2(1,1)),node_3627,pow((node_4751*saturate(node_6294)),node_1846));
