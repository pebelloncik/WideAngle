...
////// Emissive:
                ...
                float node_9746 = (node_727*(lerp( _XSize_PState, _XSize_NState, _XNegative )*(node_3066*node_3066)));
                float node_7339 = i.screenPos.rg.g;
                float node_1048 = (node_727*((node_7339*node_7339)*lerp( _YSize_PState, _YSize_NState, _sub4880371 )));
                float node_6294 = (node_9746+node_1048); // R2
                float node_744 = pow(node_6294,1.1);
                float node_8762 = (1.0+((lerp( _K_PState_copy, _K_NState_copy, _Sign_copy )+(_KCube_copy*node_744))*node_6294)); // F
