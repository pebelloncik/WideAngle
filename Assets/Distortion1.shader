...
////// Emissive:
                ...
                float node_710 = (node_7551*node_8762); // V Prime
                float2 node_1563 = lerp((i.screenPos.rg+node_8527*float2(1,1)),float2((node_6040*node_8762),node_710),pow(saturate((1.0 - sqrt(node_6294))),2.0));
